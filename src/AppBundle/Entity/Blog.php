...
class Blog
{
    const IMAGES_UPLOAD_DIR = "upload/blog/";
    ...
    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\BlogContact", mappedBy="blog")
     */
    private $contacts;
     ...
     * Add contact
     *
     * @param \AppBundle\Entity\BlogContact $contact
     *
     * @return Blog
     */
    public function addContact(\AppBundle\Entity\BlogContact $contact)
    {
     ...
     * @param \AppBundle\Entity\BlogContact $contact
     */
    public function removeContact(\AppBundle\Entity\BlogContact $contact)
    {
